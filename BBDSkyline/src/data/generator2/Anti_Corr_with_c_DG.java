...
public class Anti_Corr_with_c_DG extends DataGenerator2{

	float c;
	
	public Anti_Corr_with_c_DG(int dim, float[][] bounds, boolean isFloatEnable, double d)
			throws Exception {
	...
	public static void main(String[] args) throws Exception {
		...
		Anti_Corr_with_c_DG agc = new Anti_Corr_with_c_DG(3, bounds, false, 1);
