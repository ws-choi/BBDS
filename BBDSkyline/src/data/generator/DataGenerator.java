...
import data.Point_Float;
 ...
 abstract public class DataGenerator{
	...
	public static void main(String[] args) throws Exception {
		...
		//D_uniform Generator
//		auto_file_gen(100, data_size, new UniformDG(3, bounds, true), "UNIF_");

		//D_normal Generator
//		auto_file_gen(data_size, new NormalDG(3, bounds, true), "NORM_");
				
		//D_anti Generator
		auto_file_gen(data_size, new Anti_CorrDG(3, bounds, true, 0, 1), "ANTI_");
